//********************************************************************************************************************************
//*                                                                                                                              *
//*     ID3v1 Library 2.0.45.103 © 3delite 2010-2016                                                                             *
...
begin
    ...
    try
        ...
        Title := Trim(PAnsiCharToAnsiString(@TagData.Title, 30));
        Artist := Trim(PAnsiCharToAnsiString(@TagData.Artist, 30));
        Album := Trim(PAnsiCharToAnsiString(@TagData.Album, 30));
        Year := Trim(PAnsiCharToAnsiString(@TagData.Year, 4));
        Comment := Trim(PAnsiCharToAnsiString(@TagData.Comment, 30));
        Genre := Trim(ID3GenreDataToString(TagData.Genre));
